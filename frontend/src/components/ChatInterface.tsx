 ...
 * Provides the main user interface for interacting with the AI assistant.
 * Handles message input, scrolling, and displaying the conversation history.
 */
const ChatInterface: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-screen max-w-4xl mx-auto bg-gray-50 shadow-xl">
      ...
      {/* Error Alert */}
      {error && (
        <div className="bg-red-100 border-l-4 border-red-500 text-red-700 p-3 m-4 rounded shadow-sm animate-pulse">
